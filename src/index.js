  ...
  async fetch(request, env) {
    ...
    if (request.method === "GET" && path === "/") {
      return new Response(`
        ...
        <form method="POST">
          <label>Video URL:<br><input name="url" required style="width:100%"></label><br><br>
          <label>Alias/Kategori (misal: NEWS, MOVIE):<br><input name="alias" required style="width:100%"></label><br><br>
    ...
    if (request.method === "POST" && path === "/") {
      ...
      const videoUrl = formData.get("url")?.trim()
